...
import { canManageMasterData, isAdmin } from '../app/helpers.js';
...
export function renderSchools() {
  ...
  return `
    <div class="stack-lg">
      ...
      <section class="panel">
        <div class="panel-heading inline"><div><h3>Unidades escolares</h3><p>Cadastre os dados institucionais e mantenha os vínculos atualizados.</p></div>${canManageMasterData() ? `<button type="button" class="button primary" data-action="open-school-form">${icon('plus', 18)} Nova escola</button>` : ''}</div>
